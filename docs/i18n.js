...
export const STRINGS = {
  en: {
    ...
    "settings.octaveStyleHelp": "The flute's registers break at D, not at C, so the three D's read as low, middle and high. Notes outside the instrument's compass keep their number.",
  ...
  fr: {
    ...
    "settings.octaveStyleHelp": "Les registres de la flûte changent au ré, pas au do : les trois ré se lisent donc grave, médium et aigu. Les notes hors de l'étendue de l'instrument gardent leur numéro.",
    "compare.col.aSpread": "±A",
    "compare.col.bSpread": "±B",
