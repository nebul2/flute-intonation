...
export const STRINGS = {
  en: {
    ...
    "listen.score.offset": (offset, direction, relative) => `Your overall pitch sat ${offset} cents ${direction} — the headjoint's business, not your ear. Push it home and the note-to-note error left over would be ${relative} cents.`,
  ...
  fr: {
    ...
    "listen.score.offset": (offset, direction, relative) => `Ta hauteur d'ensemble était ${offset} cents ${direction} — affaire de tête de flûte, pas d'oreille. Enfonce-la et l'écart de note à note restant serait de ${relative} cents.`,
