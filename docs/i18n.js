...
export const STRINGS = {
  en: {
    ...
    "listen.score.offset": (offset, relative) => `Of that, ${offset} cents is a uniform shift of the whole session — the headjoint's business, not your ear. Corrected, ${relative} cents would remain.`,
  ...
  fr: {
    ...
    "listen.score.offset": (offset, relative) => `Là-dessus, ${offset} cents sont un décalage uniforme de toute la séance — affaire de tête de flûte, pas d'oreille. Corrigé, il resterait ${relative} cents.`,
